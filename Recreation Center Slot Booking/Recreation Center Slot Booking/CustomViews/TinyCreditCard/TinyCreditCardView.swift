...
private extension TinyCreditCardView {
    ...
    func initView() {
        ...
        cardNumberInputView.tintColor = UIColor.white
        cardNumberInputView.backgroundColor = UIColor.black
        
         expDateInputView.tintColor = UIColor.white
         expDateInputView.backgroundColor = UIColor.black
        
        
        
        cscNumberInputView.tintColor = UIColor.white
        cscNumberInputView.backgroundColor = UIColor.black
